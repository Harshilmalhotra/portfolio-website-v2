...
export const fallbackTechStack: TechStack[] = [
    { _id: "1", _type: "techStack", _createdAt: "", _updatedAt: "", _rev: "", name: "Next.js", icon: "", category: "Frontend" },
    { _id: "2", _type: "techStack", _createdAt: "", _updatedAt: "", _rev: "", name: "React", icon: "", category: "Frontend" },
    { _id: "3", _type: "techStack", _createdAt: "", _updatedAt: "", _rev: "", name: "Tailwind", icon: "", category: "Frontend" },
    { _id: "4", _type: "techStack", _createdAt: "", _updatedAt: "", _rev: "", name: "Node.js", icon: "", category: "Backend" },
    { _id: "5", _type: "techStack", _createdAt: "", _updatedAt: "", _rev: "", name: "PostgreSQL", icon: "", category: "Backend" },
];
